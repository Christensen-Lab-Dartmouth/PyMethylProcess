...
def run_rand_forest(train_pkl, val_pkl, test_pkl, classify=True, outcome_col='Disease_State', num_random_search=0, series=False):
...
def main():
    ...
    args=p.parse_args()
    run_rand_forest(args.train_pkl,args.val_pkl,args.test_pkl,args.classify,args.outcome_col, args.num_random_search, args.series)
